...
<head>
    ...
    <title>Sponsors | ESummit'17</title>
...
<body>
    ...
    <section id="services">
        <div class="container">
            <h1 class="title text-center wow fadeInDown" data-wow-duration="500ms" data-wow-delay="300ms">SPONSORS ESUMMIT'16</h1>
            <p class="text-center wow fadeInDown" data-wow-duration="400ms" data-wow-delay="400ms"> </p>
            <img class="img-responsive" src="images/spons.png"/>
        </div>
    </section>
